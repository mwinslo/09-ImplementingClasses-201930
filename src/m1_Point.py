...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        self.total_distance = self.total_distance + self.get_distance_from(Point(self.oldx, self.oldy))
    ...
    def get_distance_from_start(self):
        origin = Point(self.primordialx, self.primordialy)
        return self.get_distance_from(origin)

    def get_distance_traveled(self):
            return self.total_distance

    def closer_to(self, p2, p3):
        p1p2 = self.get_distance_from(p2)
        p1p3 = self.get_distance_from(p3)
        if p1p2 < p1p3:
            return p2
        else:
            if p1p3 < p1p2:
    ...
    def halfway_to(self, p2):
        return Point(.5 * (self.x + p2.x), .5 * (self.y + p2.y))
###############################################################################
